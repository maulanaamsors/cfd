                ...
                <div class="fixed-section" data-spy="affix" data-offset-top="340"><center><span class="label label-primary">   Event per Jadwal</span></center><br>
                    ...
                    <?php 
  					foreach ($jdw->result() as $j): ?>
                        ...
                        <li><a href="<?php echo base_url(); ?>welcome/listEvent/<?php echo $j->idJadwal;?>"><?php echo $j->tgl ?></a></li>
            ...
            <div class="col-md-8 col-md-offset-1">
                ...
                <h3><?php echo $no->namaCFD ?></h3>
					...
					<div class="section" id="carousel">
 					...
 					<CENTER>
 						<a href="https://www.google.co.id/maps/dir//'<?php echo $no->lat ?>,<?php echo $no->lng ?>'/@-6.8881509,107.6128083,17z/data=!3m1!4b1!4m6!4m5!1m0!1m3!2m2!1d107.615!2d-6.88767">
